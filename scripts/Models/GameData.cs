...
public static class GameData
{
    ...
    public static readonly EventCard[] EventCards =
    {
        ...
        new("bandits",           "BANDITS ON THE TRAIL.",   "res://assets/images/events/evt_bandits_threat.webp"),
        new("dust_storm",        "DUST STORM.",             "res://assets/images/events/evt_dust_storm.webp"),
        new("thunderstorm",      "THUNDERSTORM.",           "res://assets/images/events/evt_thunderstorm.webp"),
        new("heavy_fog",         "THICK FOG.",              "res://assets/images/events/evt_thick_fog.webp"),
        new("heat_wave",         "HEAT WAVE.",              "res://assets/images/events/evt_heat_wave.webp"),
        new("frozen_trail",      "FROZEN TRAIL.",           "res://assets/images/events/evt_frozen_edges.webp"),
        new("snakebite",         "SNAKEBITE!",              "res://assets/images/events/evt_snakebite.webp"),
        new("skunk_sprayed",     "SKUNK SPRAYED.",          "res://assets/images/events/evt_skunk_sprayed.webp"),
        new("ox_injured",        "OX INJURED.",             "res://assets/images/events/evt_ox_injured.webp"),
        new("ox_died",           "OX DIED.",                "res://assets/images/events/evt_ox_dead.webp"),
        new("fire_in_camp",      "FIRE IN CAMP!",           "res://assets/images/events/evt_fire_in_camp.webp"),
        new("forced_rest",       "FORCED REST.",            "res://assets/images/events/evt_forced_rest.webp"),
        new("wagon_stuck_mud",   "WAGON STUCK.",            "res://assets/images/events/evt_wagon_stuck_mud.webp"),
        new("mountain_descent",  "MOUNTAIN PASS.",          "res://assets/images/events/evt_mountain_pass.webp"),
        new("mountain_descent_injury", "MOUNTAIN FALL.",   "res://assets/images/events/evt_injury_fall.webp"),
        new("illness",           "ILLNESS.",                "res://assets/images/events/evt_illness_generic.webp"),
        new("starvation",        "STARVATION.",             "res://assets/images/events/evt_starvation.webp"),
        new("rations_low",       "RATIONS LOW.",            "res://assets/images/events/evt_rations_low.webp"),
    };
