...
public static class GameData
{
    ...
    // ========================================================================
    public record StoreStockFlags(bool Oxen, bool Food, bool Clothes, bool Bullets, bool Parts, bool Cures);

    public static readonly Dictionary<string, StoreStockFlags> StoreStock = new()
    {
        { "default",      new(true,  true, true, true, true,  true) },
        { "fort_bridger", new(false, true, true, true, true,  true) },
        { "soda_springs", new(false, true, true, true, false, true) },
        { "fort_hall",    new(true,  true, true, true, true,  true) },
        { "fort_boise",   new(false, true, true, true, true,  true) },
        { "the_dalles",   new(false, true, true, true, true,  true) },
    };
    ...
    public static readonly Dictionary<string, StoreProfile> StoreProfiles = new()
    {
        ...
        { "fort_kearny", new("FORT KEARNY POST",
            new() { {"food",1f},{"ammo",0.99f},{"parts",0.98f},{"clothes",1.02f},{"livestock",1f},{"cures",1.02f} },
        ...
        { "fort_laramie", new("FORT LARAMIE TRADERS",
            new() { {"food",1.02f},{"ammo",1f},{"parts",0.95f},{"clothes",1.04f},{"livestock",1.02f},{"cures",1.03f} },
        ...
        { "fort_bridger", new("FORT BRIDGER TRADING POST",
            new() { {"food",1.06f},{"ammo",1.05f},{"parts",0.90f},{"clothes",1.08f},{"livestock",1.05f},{"cures",1.06f} },
        ...
        { "fort_hall", new("FORT HALL POST",
            new() { {"food",1.07f},{"ammo",1.06f},{"parts",0.98f},{"clothes",1.10f},{"livestock",1.06f},{"cures",1.05f} },
